...
DEFAULT_LAYOUT = Path("/home/wxyhgk/tmp/Code/output/20260329083711-18ea65/ocr/unpacked/layout.json")
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Probe whether OCR geometry is sufficient for first-line-indent detection.")
    parser.add_argument("--layout", type=Path, default=DEFAULT_LAYOUT, help="OCR layout JSON path.")
