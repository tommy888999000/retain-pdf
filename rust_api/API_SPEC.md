...
Current scope of this first implementation:
...
- uploads in `rust_api/uploads/`
- downloads in `rust_api/downloads/`
- metadata in `rust_api/jobs.db`

Python worker still writes final artifacts to:

- `output/<job_id>/source`
- `output/<job_id>/ocr`
- `output/<job_id>/translated`
- `output/<job_id>/typst`
