...
from services.rendering.formula.core.inline_math import apply_to_non_math_segments
from services.rendering.formula.core.inline_math import build_direct_typst_passthrough_markdown
from services.rendering.formula.core.inline_math import escape_markdown_literal_asterisks
from services.rendering.formula.core.inline_math import surround_inline_math_with_spaces
...
def _sanitize_existing_inline_math_for_markdown(text: str) -> str:
    ...
    from services.rendering.formula.core.inline_math import INLINE_MATH_BLOCK_RE
